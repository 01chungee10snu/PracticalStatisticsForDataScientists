book_structure = {
    '초급': [
        ...
        {'title': '우리가 아는 것 파악하기', 'file': 'beginner/04_determine_knowledge.md'},
        {'title': '설계 선택', 'file': 'beginner/05_select_design.md'},
        {'title': '인터뷰를 통한 정보 수집', 'file': 'beginner/06_interviews.md'},
        {'title': '관찰을 통한 정보 수집', 'file': 'beginner/07_observations.md'},
        {'title': '문서를 통한 정보 수집', 'file': 'beginner/08_documents.md'},
        {'title': '정보 요약 및 해석', 'file': 'beginner/09_summary.md'},
        {'title': '결과 보고', 'file': 'beginner/10_reporting.md'},
        {'title': '사례 연구 결과 확인', 'file': 'beginner/11_confirmation.md'},
