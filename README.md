...
저작권자의 요청이 있을 경우 해당 파일은 즉시 삭제하거나 링크 형태로 대체합니다.
이러한 자료는 비상업적 학습 목적으로 사용되며, 배포보다는 참고용 링크 제공을 원칙으로 합니다.

## 학습 경로 안내
학습 자료는 [docs/index.md](docs/index.md)에서 통합 목차 형태로 확인할 수 있습니다.
...
### 향후 보완 예정
- 데이터 시각화 심화 예제를 추가해 각 통계 기법의 결과를 효과적으로 전달하는 방법을 제시할 예정입니다.
- 메타 분석과 베이지안 추정 기초를 다루는 중급 확장 장을 준비하고 있습니다.
- 실무 프로젝트를 체계적으로 진행하기 위한 템플릿과 체크리스트도 제공할 계획입니다.
